...
export class BoardService {
  ...
  async create({ idWs, ...data }: CreateBoardDto, user: User): Promise<Board> {
  ...
  async getBoardByWs(ws: string): Promise<Board[]> {
    return await this.boardRepo.find({ where: { workspace: { id: ws } } });
  }
}
